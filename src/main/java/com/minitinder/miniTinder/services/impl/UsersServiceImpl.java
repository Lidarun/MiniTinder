package com.minitinder.miniTinder.services.impl;

import com.minitinder.miniTinder.DAO.DBHelper;
import com.minitinder.miniTinder.DAO.impl.DBHelperImpl;
import com.minitinder.miniTinder.models.Gender;
import com.minitinder.miniTinder.models.Users;
import com.minitinder.miniTinder.services.UsersService;
...
public class UsersServiceImpl implements UsersService {
    ...
    public void save(Users user) {
        try (PreparedStatement prepStmt = dbHelper.getStmt
            ...
            prepStmt.setString(2, user.getGender().toString());
            prepStmt.setString(3, user.getLogin());
            prepStmt.setString(4, user.getPassword());
            prepStmt.setString(5, user.getInfo());
    ...
    public List<Users> findAll() {
        ...
        try (PreparedStatement prepStmt = dbHelper.getStmt("SELECT * FROM tb_users")){
    ...
    public Users findByID(long id) {
        ...
        try (PreparedStatement prepStmt = dbHelper.getStmt("SELECT * FROM tb_users WHERE id = ? ORDER by id")){
    ...
    public List<Users> findMale(Gender gender, List<Long> recipId) {
        List<Users> males = new ArrayList<>();
            try (PreparedStatement prepStmt = dbHelper.getStmt
                ...
                prepStmt.setString(1, String.valueOf(gender));
                ResultSet resultSet = prepStmt.executeQuery();
