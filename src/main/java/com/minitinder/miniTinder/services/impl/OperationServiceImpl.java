...
import com.minitinder.miniTinder.services.OrderService;
            ...
            while (true) {
                ...
                switch (scn.nextInt()) {
                    ...
                    case 2:
                        ...
                        } else System.out.println("Пока взаимностью никто не ответил!" + border);
                        break;
                            ...
                            while (true) {
                                ...
                                if (choose == 'Д') {
                                    ...
                                    if (answer == 1) {
                                        ...
                                        System.out.println(border + "\nВы успешно отшили пользователя!" + border);
                    ...
                    case 5:
                        ...
                        if (!orderService.notMutually(senderId).isEmpty()) {
                            orderService.notMutually(senderId).forEach(n -> System.out.println("ID: *" + n.getId() +
                                    ...
                                    "\nПол:  " + n.getGender() +
                                    "\nИнфо: " + n.getInfo() + border));
                        } else System.out.println("Вам везет, пока вас никто не отшил!" + border);
                        break;
